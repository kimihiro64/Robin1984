...
Its default target is \leanname{Solution} and uses Lake's ordinary scheduler,
allowing unrelated modules to build concurrently.  The memory-intensive
finite-certificate modules encode their order through import dependencies,
