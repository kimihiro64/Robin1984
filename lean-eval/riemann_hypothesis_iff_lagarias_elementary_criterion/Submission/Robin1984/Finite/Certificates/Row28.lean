...
/-!
# Finite Robin certificate row 28

This row covers the log-height interval
`[7349340853 / 250000, 1338267981 / 40000]`. It uses 17 cutoff thresholds, beginning at
`31426`. Its stored rational slope, gain bound, height bound, and endpoint
...
def robinFiniteRow28 : RobinFiniteRow where
  lo := (7349340853 / 250000)
  hi := (1338267981 / 40000)
  lambda := (3072760897 / 1000000000000000)
  gainUpper := (1843931474441 / 100000000000)
  heightMantissa := (15332415054936259621 / 9223372036854775808)
  logLoLower := (2572165067 / 250000000)
  logHiLower := (10418007329 / 1000000000)
  heightExponent := 45443
  cuts := [31426, 242, 43, 18, 10, 7, 5, 4, 3, 3, 3, 2, 2, 2, 2, 2, 2]

def robinFiniteRow28Blocks : List RobinPrimeProductBlock := [
  robinPrimeBlock000,
  robinPrimeBlock001,
  robinPrimeBlock002,
  robinPrimeBlock003,
...
theorem robinFiniteRow28Blocks_checks :
    forall b, Membership.mem robinFiniteRow28Blocks b -> RobinPrimeProductBlockChecks b := by
  intro b hb
  simp only [robinFiniteRow28Blocks, List.mem_cons, List.not_mem_nil, or_false] at hb
  rcases hb with hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb
  all_goals subst b
...
theorem robinFiniteRow28_products : RobinFiniteProductChecks robinFiniteRow28 := by
  apply RobinFiniteProductChecks.of_first_layer_blocks
    (c := 31426) (tail := [242, 43, 18, 10, 7, 5, 4, 3, 3, 3, 2, 2, 2, 2, 2, 2]) (bs := robinFiniteRow28Blocks) rfl
  . decide +kernel
  . exact robinFiniteRow28Blocks_checks
  . decide +kernel

set_option maxRecDepth 100000 in
set_option maxHeartbeats 40000000 in
theorem robinFiniteRow28_checks : RobinFiniteRowChecks robinFiniteRow28 := by
  apply And.intro
  . decide +kernel
  . apply And.intro
    . exact robinFiniteRow28_products
    . decide +kernel
