...
/-!
# Finite Robin certificate row 31

This row covers the log-height interval
`[1070418171 / 25000, 48110318623 / 1000000]`. It uses 18 cutoff thresholds, beginning at
`45463`. Its stored rational slope, gain bound, height bound, and endpoint
...
def robinFiniteRow31 : RobinFiniteRow where
  lo := (1070418171 / 25000)
  hi := (48110318623 / 1000000)
  lambda := (2050940953 / 1000000000000000)
  gainUpper := (9549440395651 / 500000000000)
  heightMantissa := (6136820303832988357 / 4611686018427387904)
  logLoLower := (5332342059 / 500000000)
  logHiLower := (2695312989 / 250000000)
  heightExponent := 65750
  cuts := [45463, 292, 49, 19, 11, 7, 5, 4, 4, 3, 3, 2, 2, 2, 2, 2, 2, 2]

def robinFiniteRow31Blocks : List RobinPrimeProductBlock := [
  robinPrimeBlock000,
  robinPrimeBlock001,
  robinPrimeBlock002,
  robinPrimeBlock003,
...
theorem robinFiniteRow31Blocks_checks :
    forall b, Membership.mem robinFiniteRow31Blocks b -> RobinPrimeProductBlockChecks b := by
  intro b hb
  simp only [robinFiniteRow31Blocks, List.mem_cons, List.not_mem_nil, or_false] at hb
  rcases hb with hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb
  all_goals subst b
...
theorem robinFiniteRow31_products : RobinFiniteProductChecks robinFiniteRow31 := by
  apply RobinFiniteProductChecks.of_first_layer_blocks
    (c := 45463) (tail := [292, 49, 19, 11, 7, 5, 4, 4, 3, 3, 2, 2, 2, 2, 2, 2, 2]) (bs := robinFiniteRow31Blocks) rfl
  . decide +kernel
  . exact robinFiniteRow31Blocks_checks
  . decide +kernel

set_option maxRecDepth 100000 in
set_option maxHeartbeats 40000000 in
theorem robinFiniteRow31_checks : RobinFiniteRowChecks robinFiniteRow31 := by
  apply And.intro
  . decide +kernel
  . apply And.intro
    . exact robinFiniteRow31_products
    . decide +kernel
