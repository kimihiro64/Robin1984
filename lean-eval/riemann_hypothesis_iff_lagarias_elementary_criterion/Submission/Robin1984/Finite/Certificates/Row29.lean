...
/-!
# Finite Robin certificate row 29

This row covers the log-height interval
`[1338267981 / 40000, 9481137173 / 250000]`. It uses 18 cutoff thresholds, beginning at
`35690`. Its stored rational slope, gain bound, height bound, and endpoint
...
def robinFiniteRow29 : RobinFiniteRow where
  lo := (1338267981 / 40000)
  hi := (9481137173 / 250000)
  lambda := (2672852847 / 1000000000000000)
  gainUpper := (9333484697593 / 500000000000)
  heightMantissa := (1323398228959304581 / 1152921504606846976)
  logLoLower := (10418007329 / 1000000000)
  logHiLower := (10543353903 / 1000000000)
  heightExponent := 51624
  cuts := [35690, 258, 45, 18, 10, 7, 5, 4, 3, 3, 3, 2, 2, 2, 2, 2, 2, 2]

def robinFiniteRow29Blocks : List RobinPrimeProductBlock := [
  robinPrimeBlock000,
  robinPrimeBlock001,
  robinPrimeBlock002,
  robinPrimeBlock003,
...
theorem robinFiniteRow29Blocks_checks :
    forall b, Membership.mem robinFiniteRow29Blocks b -> RobinPrimeProductBlockChecks b := by
  intro b hb
  simp only [robinFiniteRow29Blocks, List.mem_cons, List.not_mem_nil, or_false] at hb
  rcases hb with hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb
  all_goals subst b
...
theorem robinFiniteRow29_products : RobinFiniteProductChecks robinFiniteRow29 := by
  apply RobinFiniteProductChecks.of_first_layer_blocks
    (c := 35690) (tail := [258, 45, 18, 10, 7, 5, 4, 3, 3, 3, 2, 2, 2, 2, 2, 2, 2]) (bs := robinFiniteRow29Blocks) rfl
  . decide +kernel
  . exact robinFiniteRow29Blocks_checks
  . decide +kernel

set_option maxRecDepth 100000 in
set_option maxHeartbeats 40000000 in
theorem robinFiniteRow29_checks : RobinFiniteRowChecks robinFiniteRow29 := by
  apply And.intro
  . decide +kernel
  . apply And.intro
    . exact robinFiniteRow29_products
    . decide +kernel
