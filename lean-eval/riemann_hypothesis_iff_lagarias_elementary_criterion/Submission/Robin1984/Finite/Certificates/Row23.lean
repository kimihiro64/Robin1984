...
/-!
# Finite Robin certificate row 23

This row covers the log-height interval
`[179906601 / 12500, 16784073643 / 1000000]`. It uses 16 cutoff thresholds, beginning at
`15587`. Its stored rational slope, gain bound, height bound, and endpoint
...
def robinFiniteRow23 : RobinFiniteRow where
  lo := (179906601 / 12500)
  hi := (16784073643 / 1000000)
  lambda := (6644793849 / 1000000000000000)
  gainUpper := (8596022645987 / 500000000000)
  heightMantissa := (30742308875954151977 / 18446744073709551616)
  logLoLower := (4787232233 / 500000000)
  logHiLower := (9728185717 / 1000000000)
  heightExponent := 22606
  cuts := [15587, 170, 34, 15, 9, 6, 4, 4, 3, 3, 2, 2, 2, 2, 2, 2]

def robinFiniteRow23Blocks : List RobinPrimeProductBlock := [
  robinPrimeBlock000,
  robinPrimeBlock001,
  robinPrimeBlock002,
  robinPrimeBlock003,
...
theorem robinFiniteRow23Blocks_checks :
    forall b, Membership.mem robinFiniteRow23Blocks b -> RobinPrimeProductBlockChecks b := by
  intro b hb
  simp only [robinFiniteRow23Blocks, List.mem_cons, List.not_mem_nil, or_false] at hb
  rcases hb with hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb
  all_goals subst b
...
theorem robinFiniteRow23_products : RobinFiniteProductChecks robinFiniteRow23 := by
  apply RobinFiniteProductChecks.of_first_layer_blocks
    (c := 15587) (tail := [170, 34, 15, 9, 6, 4, 4, 3, 3, 2, 2, 2, 2, 2, 2]) (bs := robinFiniteRow23Blocks) rfl
  . decide +kernel
  . exact robinFiniteRow23Blocks_checks
  . decide +kernel

set_option maxRecDepth 100000 in
set_option maxHeartbeats 40000000 in
theorem robinFiniteRow23_checks : RobinFiniteRowChecks robinFiniteRow23 := by
  apply And.intro
  . decide +kernel
  . apply And.intro
    . exact robinFiniteRow23_products
    . decide +kernel
