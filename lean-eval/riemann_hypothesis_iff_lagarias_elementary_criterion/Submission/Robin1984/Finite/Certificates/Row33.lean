...
/-!
# Finite Robin certificate row 33

This row covers the log-height interval
`[10789326747 / 200000, 30165067587 / 500000]`. It uses 18 cutoff thresholds, beginning at
`57137`. Its stored rational slope, gain bound, height bound, and endpoint
...
def robinFiniteRow33 : RobinFiniteRow where
  lo := (10789326747 / 200000)
  hi := (30165067587 / 500000)
  lambda := (1597827091 / 1000000000000000)
  gainUpper := (19507473855129 / 1000000000000)
  heightMantissa := (9344333232307084435 / 9223372036854775808)
  logLoLower := (10895750571 / 1000000000)
  logHiLower := (11007587011 / 1000000000)
  heightExponent := 82678
  cuts := [57137, 328, 53, 21, 11, 8, 6, 4, 4, 3, 3, 2, 2, 2, 2, 2, 2, 2]

def robinFiniteRow33Blocks : List RobinPrimeProductBlock := [
  robinPrimeBlock000,
  robinPrimeBlock001,
  robinPrimeBlock002,
  robinPrimeBlock003,
...
theorem robinFiniteRow33Blocks_checks :
    forall b, Membership.mem robinFiniteRow33Blocks b -> RobinPrimeProductBlockChecks b := by
  intro b hb
  simp only [robinFiniteRow33Blocks, List.mem_cons, List.not_mem_nil, or_false] at hb
  rcases hb with hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb
  all_goals subst b
...
theorem robinFiniteRow33_products : RobinFiniteProductChecks robinFiniteRow33 := by
  apply RobinFiniteProductChecks.of_first_layer_blocks
    (c := 57137) (tail := [328, 53, 21, 11, 8, 6, 4, 4, 3, 3, 2, 2, 2, 2, 2, 2, 2]) (bs := robinFiniteRow33Blocks) rfl
  . decide +kernel
  . exact robinFiniteRow33Blocks_checks
  . decide +kernel

set_option maxRecDepth 100000 in
set_option maxHeartbeats 40000000 in
theorem robinFiniteRow33_checks : RobinFiniteRowChecks robinFiniteRow33 := by
  apply And.intro
  . decide +kernel
  . apply And.intro
    . exact robinFiniteRow33_products
    . decide +kernel
