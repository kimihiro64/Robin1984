import Submission.Robin1984.Equivalence.ReducedProductChecks
import Submission.Robin1984.Finite.Certificates.PrimeBlocks00
import Submission.Robin1984.Finite.Certificates.PrimeBlocks01
import Submission.Robin1984.Finite.Certificates.PrimeBlocks02
import Submission.Robin1984.Finite.Certificates.PrimeBlocks03
import Submission.Robin1984.Finite.Certificates.PrimeBlocks04
import Submission.Robin1984.Finite.Certificates.PrimeBlocks05
import Submission.Robin1984.Finite.Certificates.PrimeBlocks06
import Submission.Robin1984.Finite.Certificates.PrimeBlocks07
import Submission.Robin1984.Finite.Certificates.PrimeBlocks08
import Submission.Robin1984.Finite.Certificates.PrimeBlocks09
import Submission.Robin1984.Finite.Certificates.PrimeBlocks10
import Submission.Robin1984.Finite.Certificates.PrimeBlocks11
import Submission.Robin1984.Finite.Certificates.PrimeBlocks12
import Submission.Robin1984.Finite.Certificates.PrimeBlocks13
/-!
## Provenance
...
/-!
# Finite Robin certificate row 35

This row covers the log-height interval
`[33566442549 / 500000, 37283397387 / 500000]`. It uses 19 cutoff thresholds, beginning at
`70849`. Its stored rational slope, gain bound, height bound, and endpoint
...
def robinFiniteRow35 : RobinFiniteRow where
  lo := (33566442549 / 500000)
  hi := (37283397387 / 500000)
  lambda := (157973183 / 125000000000000)
  gainUpper := (19886145984323 / 1000000000000)
  heightMantissa := (33702234942557961101 / 18446744073709551616)
  logLoLower := (2778607323 / 250000000)
  logHiLower := (448778023 / 40000000)
  heightExponent := 102220
  cuts := [70849, 365, 57, 22, 12, 8, 6, 5, 4, 3, 3, 2, 2, 2, 2, 2, 2, 2, 2]

def robinFiniteRow35Blocks : List RobinPrimeProductBlock := [
  robinPrimeBlock000,
  robinPrimeBlock001,
  robinPrimeBlock002,
  robinPrimeBlock003,
...
theorem robinFiniteRow35Blocks_checks :
    forall b, Membership.mem robinFiniteRow35Blocks b -> RobinPrimeProductBlockChecks b := by
  intro b hb
  simp only [robinFiniteRow35Blocks, List.mem_cons, List.not_mem_nil, or_false] at hb
  rcases hb with hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb
  all_goals subst b
...
theorem robinFiniteRow35_products : RobinFiniteProductChecks robinFiniteRow35 := by
  apply RobinFiniteProductChecks.of_first_layer_blocks
    (c := 70849) (tail := [365, 57, 22, 12, 8, 6, 5, 4, 3, 3, 2, 2, 2, 2, 2, 2, 2, 2]) (bs := robinFiniteRow35Blocks) rfl
  . decide +kernel
  . exact robinFiniteRow35Blocks_checks
  . decide +kernel

set_option maxRecDepth 100000 in
set_option maxHeartbeats 40000000 in
theorem robinFiniteRow35_checks : RobinFiniteRowChecks robinFiniteRow35 := by
  apply And.intro
  . decide +kernel
  . apply And.intro
    . exact robinFiniteRow35_products
    . decide +kernel
