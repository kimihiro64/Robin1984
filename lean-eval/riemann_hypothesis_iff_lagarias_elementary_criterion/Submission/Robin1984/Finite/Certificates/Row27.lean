...
/-!
# Finite Robin certificate row 27

This row covers the log-height interval
`[1287242339 / 50000, 7349340853 / 250000]`. It uses 17 cutoff thresholds, beginning at
`27570`. Its stored rational slope, gain bound, height bound, and endpoint
...
def robinFiniteRow27 : RobinFiniteRow where
  lo := (1287242339 / 50000)
  hi := (7349340853 / 250000)
  lambda := (3547339421 / 1000000000000000)
  gainUpper := (4551087575717 / 250000000000)
  heightMantissa := (7516258340239357411 / 4611686018427387904)
  logLoLower := (7934367 / 781250)
  logHiLower := (2572165067 / 250000000)
  heightExponent := 39837
  cuts := [27570, 227, 41, 17, 10, 7, 5, 4, 3, 3, 2, 2, 2, 2, 2, 2, 2]

def robinFiniteRow27Blocks : List RobinPrimeProductBlock := [
  robinPrimeBlock000,
  robinPrimeBlock001,
  robinPrimeBlock002,
  robinPrimeBlock003,
...
theorem robinFiniteRow27Blocks_checks :
    forall b, Membership.mem robinFiniteRow27Blocks b -> RobinPrimeProductBlockChecks b := by
  intro b hb
  simp only [robinFiniteRow27Blocks, List.mem_cons, List.not_mem_nil, or_false] at hb
  rcases hb with hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb
  all_goals subst b
...
theorem robinFiniteRow27_products : RobinFiniteProductChecks robinFiniteRow27 := by
  apply RobinFiniteProductChecks.of_first_layer_blocks
    (c := 27570) (tail := [227, 41, 17, 10, 7, 5, 4, 3, 3, 2, 2, 2, 2, 2, 2, 2]) (bs := robinFiniteRow27Blocks) rfl
  . decide +kernel
  . exact robinFiniteRow27Blocks_checks
  . decide +kernel

set_option maxRecDepth 100000 in
set_option maxHeartbeats 40000000 in
theorem robinFiniteRow27_checks : RobinFiniteRowChecks robinFiniteRow27 := by
  apply And.intro
  . decide +kernel
  . apply And.intro
    . exact robinFiniteRow27_products
    . decide +kernel
