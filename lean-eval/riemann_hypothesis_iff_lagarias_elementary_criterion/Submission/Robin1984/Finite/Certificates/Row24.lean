...
/-!
# Finite Robin certificate row 24

This row covers the log-height interval
`[16784073643 / 1000000, 9718846411 / 500000]`. It uses 16 cutoff thresholds, beginning at
`18110`. Its stored rational slope, gain bound, height bound, and endpoint
...
def robinFiniteRow24 : RobinFiniteRow where
  lo := (16784073643 / 1000000)
  hi := (9718846411 / 500000)
  lambda := (1126354703 / 200000000000000)
  gainUpper := (4364402569827 / 250000000000)
  heightMantissa := (24737355459205177439 / 18446744073709551616)
  logLoLower := (9728185717 / 1000000000)
  logHiLower := (9874969387 / 1000000000)
  heightExponent := 26225
  cuts := [18110, 184, 36, 15, 9, 6, 5, 4, 3, 3, 2, 2, 2, 2, 2, 2]

def robinFiniteRow24Blocks : List RobinPrimeProductBlock := [
  robinPrimeBlock000,
  robinPrimeBlock001,
  robinPrimeBlock002,
  robinPrimeBlock003,
...
theorem robinFiniteRow24Blocks_checks :
    forall b, Membership.mem robinFiniteRow24Blocks b -> RobinPrimeProductBlockChecks b := by
  intro b hb
  simp only [robinFiniteRow24Blocks, List.mem_cons, List.not_mem_nil, or_false] at hb
  rcases hb with hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb
  all_goals subst b
...
theorem robinFiniteRow24_products : RobinFiniteProductChecks robinFiniteRow24 := by
  apply RobinFiniteProductChecks.of_first_layer_blocks
    (c := 18110) (tail := [184, 36, 15, 9, 6, 5, 4, 3, 3, 2, 2, 2, 2, 2, 2]) (bs := robinFiniteRow24Blocks) rfl
  . decide +kernel
  . exact robinFiniteRow24Blocks_checks
  . decide +kernel

set_option maxRecDepth 100000 in
set_option maxHeartbeats 40000000 in
theorem robinFiniteRow24_checks : RobinFiniteRowChecks robinFiniteRow24 := by
  apply And.intro
  . decide +kernel
  . apply And.intro
    . exact robinFiniteRow24_products
    . decide +kernel
