...
/-!
# Finite Robin certificate row 34

This row covers the log-height interval
`[30165067587 / 500000, 33566442549 / 500000]`. It uses 18 cutoff thresholds, beginning at
`63731`. Its stored rational slope, gain bound, height bound, and endpoint
...
def robinFiniteRow34 : RobinFiniteRow where
  lo := (30165067587 / 500000)
  hi := (33566442549 / 500000)
  lambda := (1418388113 / 1000000000000000)
  gainUpper := (4925509389567 / 250000000000)
  heightMantissa := (5698791309671685549 / 4611686018427387904)
  logLoLower := (11007587011 / 1000000000)
  logHiLower := (2778607323 / 250000000)
  heightExponent := 92192
  cuts := [63731, 346, 55, 21, 12, 8, 6, 4, 4, 3, 3, 2, 2, 2, 2, 2, 2, 2]

def robinFiniteRow34Blocks : List RobinPrimeProductBlock := [
  robinPrimeBlock000,
  robinPrimeBlock001,
  robinPrimeBlock002,
  robinPrimeBlock003,
...
theorem robinFiniteRow34Blocks_checks :
    forall b, Membership.mem robinFiniteRow34Blocks b -> RobinPrimeProductBlockChecks b := by
  intro b hb
  simp only [robinFiniteRow34Blocks, List.mem_cons, List.not_mem_nil, or_false] at hb
  rcases hb with hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb
  all_goals subst b
...
theorem robinFiniteRow34_products : RobinFiniteProductChecks robinFiniteRow34 := by
  apply RobinFiniteProductChecks.of_first_layer_blocks
    (c := 63731) (tail := [346, 55, 21, 12, 8, 6, 4, 4, 3, 3, 2, 2, 2, 2, 2, 2, 2]) (bs := robinFiniteRow34Blocks) rfl
  . decide +kernel
  . exact robinFiniteRow34Blocks_checks
  . decide +kernel

set_option maxRecDepth 100000 in
set_option maxHeartbeats 40000000 in
theorem robinFiniteRow34_checks : RobinFiniteRowChecks robinFiniteRow34 := by
  apply And.intro
  . decide +kernel
  . apply And.intro
    . exact robinFiniteRow34_products
    . decide +kernel
