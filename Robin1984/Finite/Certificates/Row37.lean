...
/-!
# Finite Robin certificate row 37

This row covers the log-height interval
`[41321869833 / 500000, 285455918 / 3125]`. It uses 19 cutoff thresholds, beginning at
`86994`. Its stored rational slope, gain bound, height bound, and endpoint
...
def robinFiniteRow37 : RobinFiniteRow where
  lo := (41321869833 / 500000)
  hi := (285455918 / 3125)
  lambda := (505334013 / 500000000000000)
  gainUpper := (5063568094031 / 250000000000)
  heightMantissa := (8040443378910893733 / 4611686018427387904)
  logLoLower := (5661147177 / 500000000)
  logHiLower := (11422408609 / 1000000000)
  heightExponent := 125653
  cuts := [86994, 405, 61, 23, 12, 8, 6, 5, 4, 3, 3, 3, 2, 2, 2, 2, 2, 2, 2]

def robinFiniteRow37Blocks : List RobinPrimeProductBlock := [
  robinPrimeBlock000,
  robinPrimeBlock001,
  robinPrimeBlock002,
  robinPrimeBlock003,
...
theorem robinFiniteRow37Blocks_checks :
    forall b, Membership.mem robinFiniteRow37Blocks b -> RobinPrimeProductBlockChecks b := by
  intro b hb
  simp only [robinFiniteRow37Blocks, List.mem_cons, List.not_mem_nil, or_false] at hb
  rcases hb with hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb
  all_goals subst b
...
theorem robinFiniteRow37_products : RobinFiniteProductChecks robinFiniteRow37 := by
  apply RobinFiniteProductChecks.of_first_layer_blocks
    (c := 86994) (tail := [405, 61, 23, 12, 8, 6, 5, 4, 3, 3, 3, 2, 2, 2, 2, 2, 2, 2]) (bs := robinFiniteRow37Blocks) rfl
  . decide +kernel
  . exact robinFiniteRow37Blocks_checks
  . decide +kernel

set_option maxRecDepth 100000 in
set_option maxHeartbeats 40000000 in
theorem robinFiniteRow37_checks : RobinFiniteRowChecks robinFiniteRow37 := by
  apply And.intro
  . decide +kernel
  . apply And.intro
    . exact robinFiniteRow37_products
    . decide +kernel
