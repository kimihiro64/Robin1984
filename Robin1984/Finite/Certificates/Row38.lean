...
import Robin1984.Finite.Certificates.PrimeBlocks15
import Robin1984.Finite.Certificates.PrimeBlocks16
...
/-!
# Final finite row: prime-product assembly

The first cutoff of row 38 is 95672, so its first layer needs exact products
over every prime at most 95672. This module orders the 132 verified blocks
covering `[0, 95673)`, proves that every listed block passes its product check,
and concatenates them into the three required prime-prefix products.

`robinFiniteRow38_checks` combines those products with the layer and endpoint
certificates from `Row38Layers` to produce the complete final row theorem.
-/

namespace Robin1984

def robinFiniteRow38Blocks : List RobinPrimeProductBlock := [
  robinPrimeBlock000,
  robinPrimeBlock001,
  robinPrimeBlock002,
  robinPrimeBlock003,
...
theorem robinFiniteRow38Blocks_checks :
    forall b, Membership.mem robinFiniteRow38Blocks b -> RobinPrimeProductBlockChecks b := by
  intro b hb
  simp only [robinFiniteRow38Blocks, List.mem_cons, List.not_mem_nil, or_false] at hb
  rcases hb with hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb | hb
  all_goals subst b
  ...
  . exact robinPrimeBlock113_checks
  . exact robinPrimeBlock114_checks
  . exact robinPrimeBlock115_checks
  . exact robinPrimeBlock116_checks
  . exact robinPrimeBlock117_checks
  . exact robinPrimeBlock118_checks
  . exact robinPrimeBlock119_checks
  . exact robinPrimeBlock120_checks
  . exact robinPrimeBlock121_checks
  . exact robinPrimeBlock122_checks
  . exact robinPrimeBlock123_checks
  . exact robinPrimeBlock124_checks
  . exact robinPrimeBlock125_checks
  . exact robinPrimeBlock126_checks
  . exact robinPrimeBlock127_checks
  . exact robinPrimeBlock128_checks
  . exact robinPrimeBlock129_checks
  . exact robinPrimeBlock130_checks
  . exact robinPrimeBlock131_checks

set_option maxRecDepth 100000 in
set_option maxHeartbeats 40000000 in
theorem robinFiniteRow38_products : RobinFiniteProductChecks robinFiniteRow38 := by
  apply RobinFiniteProductChecks.of_first_layer_blocks
    (c := 95672) (tail := [425, 63, 23, 13, 8, 6, 5, 4, 3, 3, 3, 2, 2, 2, 2, 2, 2, 2]) (bs := robinFiniteRow38Blocks) rfl
  . decide +kernel
  . exact robinFiniteRow38Blocks_checks
  . decide +kernel

set_option maxRecDepth 100000 in
set_option maxHeartbeats 40000000 in
theorem robinFiniteRow38_checks : RobinFiniteRowChecks robinFiniteRow38 := by
  exact And.intro robinFiniteRow38_layers (And.intro robinFiniteRow38_products robinFiniteRow38_endpoints)
